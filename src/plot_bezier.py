...
def plot_bezier(c, width = 0, height = 0, plot_details=False, animation=False, save = False, color='k', fig = None):
    ...
    if animation:
        ...
        plt.plot(px, py, linewidth=1, color=color)
        if plot_details:
            # plt.plot(x, y, 'bo', markersize=2, color=color) # plot waypoints
